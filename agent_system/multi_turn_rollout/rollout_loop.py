...
class TrajectoryCollector:
    ...
    def gather_rollout_data(
        ...
        writing_reward = success['writing_reward']
        del success['coverage']
        del success['accuracy']
        del success['writing_reward']
        ...
        for bs in range(batch_size):
            for data in total_batch_list[bs]:
                ...
                if data['active_masks']:
                    ...
                    data['coverage'] = coverage[bs]
                    data['accuracy'] = accuracy[bs]
                    data['writing_reward'] = writing_reward[bs]
